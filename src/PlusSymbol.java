...
public class PlusSymbol extends MathematicalSymbols{

	public PlusSymbol(int row_coordinate, int column_coordinate) {
	...
	int match(GameGrid gameGrid) {
		int score = 0;
		try {
			if (gameGrid.getGameGrid().get(this.getRow_coordinate()).get(this.getColumn_coordinate()-2) instanceof MathematicalSymbols && gameGrid.getGameGrid().get(this.getRow_coordinate()).get(this.getColumn_coordinate()-1) instanceof MathematicalSymbols) 
			{
		...
		try {
			if (gameGrid.getGameGrid().get(this.getRow_coordinate()-2).get(this.getColumn_coordinate()) instanceof MathematicalSymbols && gameGrid.getGameGrid().get(this.getRow_coordinate()-1).get(this.getColumn_coordinate()) instanceof MathematicalSymbols) 
			{
