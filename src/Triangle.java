...
public class Triangle extends NormalJewel{

	private final int number_of_points = 15;
	public Triangle(int row_coordinate, int column_coordinate) {
	...
	int match(GameGrid gameGrid) {
		int score = 0;
		try {
			if (gameGrid.getGameGrid().get(this.getRow_coordinate()-2).get(this.getColumn_coordinate()) instanceof Triangle && gameGrid.getGameGrid().get(this.getRow_coordinate()-1).get(this.getColumn_coordinate()) instanceof Triangle) 
			{
	...
	public int fake_match(GameGrid gameGrid) {
		int score = 0;
		try {
			if (gameGrid.getGameGrid().get(this.getRow_coordinate()-2).get(this.getColumn_coordinate()).getClass().equals(gameGrid.getGameGrid().get(this.getRow_coordinate()-1).get(this.getColumn_coordinate()).getClass()) && gameGrid.getGameGrid().get(this.getRow_coordinate()-1).get(this.getColumn_coordinate()) instanceof NormalJewel) 
			{
				Jewel jewel1 = gameGrid.getGameGrid().get(this.getRow_coordinate()-2).get(this.getColumn_coordinate());
				Jewel jewel2 = gameGrid.getGameGrid().get(this.getRow_coordinate()-1).get(this.getColumn_coordinate());
				Jewel jewel3 = gameGrid.getGameGrid().get(this.getRow_coordinate()).get(this.getColumn_coordinate());
